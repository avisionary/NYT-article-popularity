...
We can see that the median is almost the same for every week number which means that our initial hypothesis was not true. So we can take a common threshold for all. We have chosen 100 as a threshold for the popularity.
